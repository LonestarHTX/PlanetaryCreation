...
{
	UE_LOG(LogPlanetaryCreation, Log, TEXT("=== Starting Milestone 5 Task 1.3: Undo/Redo UI Test ==="));
	...
	UE_LOG(LogPlanetaryCreation, Log, TEXT("Test 1: Reset initializes history..."));
	...
	UE_LOG(LogPlanetaryCreation, Log, TEXT("Test 2: AdvanceSteps captures history..."));
	...
	UE_LOG(LogPlanetaryCreation, Log, TEXT("Test 3: Undo restores state..."));
	...
	UE_LOG(LogPlanetaryCreation, Log, TEXT("Test 4: Multiple undos..."));
	Service->Undo();
	Service->Undo();
	...
	UE_LOG(LogPlanetaryCreation, Log, TEXT("Test 5: Undo at boundary..."));
	TestFalse(TEXT("Undo should fail at history start"), Service->Undo());

	// === Test 6: Redo restores forward state ===
	UE_LOG(LogPlanetaryCreation, Log, TEXT("Test 6: Redo restores state..."));
	...
	UE_LOG(LogPlanetaryCreation, Log, TEXT("Test 7: Multiple redos..."));
	Service->Redo();
	Service->Redo();
	...
	UE_LOG(LogPlanetaryCreation, Log, TEXT("Test 8: Redo at boundary..."));
	TestFalse(TEXT("Redo should fail at history end"), Service->Redo());

	// === Test 9: New step after undo truncates future history ===
	UE_LOG(LogPlanetaryCreation, Log, TEXT("Test 9: New step truncates future history..."));
	...
	UE_LOG(LogPlanetaryCreation, Log, TEXT("Test 10: JumpToHistoryIndex..."));
	...
	UE_LOG(LogPlanetaryCreation, Log, TEXT("Test 11: GetHistorySnapshotAt..."));
	...
	UE_LOG(LogPlanetaryCreation, Log, TEXT("Test 12: Max history size enforcement..."));
	Service->ResetSimulation();
	...
	UE_LOG(LogPlanetaryCreation, Log, TEXT("=== Milestone 5 Task 1.3: Undo/Redo UI Test PASSED ==="));
	return true;
}
